...
async def analyze_media(
    ...
    try:
        ...
        KEEP THE LENGTH OF THE CAPTIONS BELOW TO 250 CHARACTERS
        ALWAYS INCLUDE APPROPRIATE HASHTAGS IN CAPTIONS
        Example: 
  ...
  "captions": [
    {{
      ...
      #NatureLovers #DesertVibes #ScenicViews #TravelGram #AdventureAwaits"
    }},
    {{
      ...
      #CanyonViews #TravelPhotography #ExploreMore #NatureBeauty #HikingAdventures"
    }},
    {{
      ...
      #Wanderlust #EarthPorn #IntoTheWild #MountainMagic #ScenicEscape"
    }},
    {{
      ...
      #NatureLover #DesertDreaming #SkyHigh #GeologyRocks #EpicScenery"
    }}
  ]
}}
        """.format(
